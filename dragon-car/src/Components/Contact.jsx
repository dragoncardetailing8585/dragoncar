        ...
        <div className="bg-white bg-opacity-10 backdrop-blur-lg border border-blue-400 border-opacity-30 rounded-2xl shadow-2xl p-8 animate-fade-in self-center" data-aos="zoom-in" data-aos-delay="200">
          ...
          <form className="space-y-6">
            <div className="relative">
              ...
              <input type="text" placeholder="Enter your name" className="w-full px-4 pl-10 py-3 rounded-lg bg-gray-900 bg-opacity-70 border border-blue-700 text-white focus:outline-none focus:ring-2 focus:ring-blue-400 transition placeholder-gray-400" />
            </div>
            <div className="relative">
              <label className="block text-sm font-medium text-blue-200 mb-1">Your Email</label>
              <span className="absolute left-3 top-9 text-blue-400 text-xl">📧</span>
              <input type="email" placeholder="Enter your email" className="w-full px-4 pl-10 py-3 rounded-lg bg-gray-900 bg-opacity-70 border border-blue-700 text-white focus:outline-none focus:ring-2 focus:ring-blue-400 transition placeholder-gray-400" />
            </div>
            <div className="relative">
              <label className="block text-sm font-medium text-blue-200 mb-1">Your Message</label>
              <span className="absolute left-3 top-9 text-blue-400 text-xl">💬</span>
              <textarea placeholder="Write your message here..." rows="4" className="w-full px-4 pl-10 py-3 rounded-lg bg-gray-900 bg-opacity-70 border border-blue-700 text-white focus:outline-none focus:ring-2 focus:ring-blue-400 transition placeholder-gray-400"></textarea>
            </div>
